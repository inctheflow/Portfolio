    ...
    >
      ...
      <div className="flex flex-col-reverse space-y-10 items-center justify-center mx-10 md:flex-row md:space-x-24 md:space-y-0 md:p-4">
        ...
        >
          ...
          <a href="mailto:adityarajpoudel@gmail.com">
      ...
      <h3 className="text-center pt-12 md:inline text-md md:border-l-8 border-dark dark:border-light md:px-4 md:py-2 p-12 font-bold dark:text-light text-dark">
